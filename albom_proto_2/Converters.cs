...
namespace albom_proto_2
{
    ...
    {
        public string Convert(string value, Type targetType, object parameter, CultureInfo culture)
        ...
        public object ConvertBack(string value, Type targetTypes, object parameter, CultureInfo culture)
        {
            //string exposure = ((string)value).Substring(2);
            return value;
            //(1 / Decimal.Parse(exposure));
        }
    }
    ...
    public class PhotoSizeConverter : IMultiValueConverter
    {
        public object Convert(object[] values, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            {
                return String.Format("{0}*{1} {2}b", values[0], values[1], values[2]);
            }
        }
